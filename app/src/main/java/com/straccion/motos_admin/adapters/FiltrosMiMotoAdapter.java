...
public class FiltrosMiMotoAdapter extends FirestoreRecyclerAdapter<PostAuteco, FiltrosMiMotoAdapter.ViewHolder> {

    Context contexto;
    androidx.navigation.NavController NavController;
    public FiltrosMiMotoAdapter(FirestoreRecyclerOptions<PostAuteco> options, Context context, NavController navController){
        super(options);
